	...
	namespace {
		...
		bool create_fx_pso_and_root_signature()
		{
            ...
            struct {
                ...
                d3dx::d3d12_pipeline_state_subobject_vs                         vs{ shaders::get_agilis_shader(shaders::agilis_shader::fullscreen_triangle_vs) };
                d3dx::d3d12_pipeline_state_subobject_ps                         ps{ shaders::get_agilis_shader(shaders::agilis_shader::post_process_ps) };
