...
namespace primal::script{
	namespace {
		...
		{
			//NOTE: put this static variable in a func because of the initilizaiton order of static data
			// This way we can certain that the data is initialized before accessing it.
